			...
			<view class="cu-dialog">
				...
				<view class="grid-body">
					...
					<view class="grid-flex padding-10">
						...
						<view>
							<text>工时:{{findGoodsTableDataItems.hp_WorkTime}}</text>
						</view>
						<view>
				...
				<view class="updete grid-flex" v-show="modalTitle=='修改'?'show':''">
						...
						<input type="number"  style=" border: 1px solid red; width: 30%;" v-model="hp_WorkTime"/>
				</view>
				...
				<view class="cu-bar bg-white justify-end">
					...
					<view class="grid-body">
						...
						<view class="flex border-top">
							...
							<view class="flex-sub">
								<view class="cu-form-group">
									<view class="title">工ㅤ时:</view>
									<input type="number" v-model="uptatefrom.hp_WorkTime" placeholder="请输入工时" />
								</view>
							</view>
							<!-- <view class="flex-sub">
								<view class="cu-form-group">
