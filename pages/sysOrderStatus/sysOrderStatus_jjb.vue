			...
			<view class="flex border-top">
				...
				<view class="flex-sub">
					<view class="cu-form-group">
						...
						<input type="number" v-model="formItem.paperLength" placeholder="请输入纸长" />
					</view>
				</view>
			</view>
			<view class="flex border-top">
				...
				<view class="flex-sub">
					<view class="cu-form-group">
						...
						<input type="number" v-model="formItem.qty" placeholder="请输入数量" />
					</view>
				</view>
			</view>
		</form>
		...
		<view class="border-bottom grid-warp" v-for="(item,index) in orderList" @click="seeDetails(index)">
			...
			<view class="grid-body">
				...
				<view class="grid-flex padding-10">
					...
					<view>
						<text>压线:{{item.co_YxStr}}</text>
					</view>
				</view>
				<view class="grid-flex padding-10">
					<view>
						<text>价格:{{item.co_Price}}</text>
					</view>
					<view>
						<text>金额:{{item.co_Money}}</text>
					</view>
				</view>
				<view class="grid-flex padding-10">
					<view>
						<text>生产备注:{{item.co_Oremark}}</text>
					</view>
				</view>
				<view class="grid-flex padding-10">
					<view>
						<text>送货备注:{{item.co_Remark}}</text>
					</view>
				</view>
			</view>
		</view>
