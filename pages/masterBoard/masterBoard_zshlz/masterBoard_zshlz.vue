			...
			<view class="grid-body" style="text-align: right;">
				<view>
					<uni-grid :column="3" :square="false" :highlight="false" :showBorder="false">
						...
						<uni-grid-item>
							<view class="price-mini-panel">
								<view class="textrignt textright">
						   ...
						   <!--订单金额(万) 月-->
						<uni-grid-item>
							<view class="price-mini-panel textright">
								<view>
						...
						<uni-grid-item>
						  ...
						  <!--生产面积(万) 天-->
						<uni-grid-item>
							<view class="special-mini-panel textright">
								<view>
				...
				<view>
					<uni-grid :column="3" :square="false" :highlight="false" :showBorder="false">
						...
						<uni-grid-item>
							<view class="price-mini-panel textright">
								<view>
									<text class="text">{{addThousandthSign(formItem.SPaperIn_DWt)}}</text>
								</view>
							</view>
						</uni-grid-item>
						   <!--入库重量(吨) 月-->
						<uni-grid-item>
							<view class="price-mini-panel textright">
								<view>
									<text class="text">{{addThousandthSign(formItem.SPaperIn_MWt)}}</text>
								</view>
							</view>
						</uni-grid-item>
						...
						<uni-grid-item>
							<view class="price-mini-panel textright">
								<view>
									<text class="text">{{addThousandthSign(formItem.SPaperOut_DWt)}}</text>
								</view>
							</view>
						</uni-grid-item>
						   <!--出库重量(吨) 月-->
						<uni-grid-item>
							<view class="price-mini-panel textright">
								<view>
									<text class="text">{{addThousandthSign(formItem.SPaperOut_MWt)}}</text>
								</view>
							</view>
						</uni-grid-item>
