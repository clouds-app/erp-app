			...
			<view class="flex border-top">
				<view class="flex-sub">
					<selectDropdown
						...
						:params="{modelCode:'paper_profit_sum'}"
					></selectDropdown>
				...
				<view class="flex-sub">
					<view class="cu-form-group">
						<view class="fixed-left">
							...
							<button :disabled="isLoaddingData" :style="{color: formItem.searchMode=='1'?'red':''}" class=" margin-left cu-btn round line-brown" @click="searchModeClick('1')" >业务</button>
							<button :disabled="isLoaddingData" :style="{color: formItem.searchMode=='3'?'red':''}" class=" margin-left cu-btn round line-green" @click="searchModeClick('3')" >材质</button>
						</view>
				   </view>
...
export default {
	...
	data() {
		return {
			...
			dataColumnsCopy:[
				...
				{ key: 'BMoney', title: '金额', $width: 180, titleAlign: 'center', columnAlign: 'right' },
				{ key: 'profit', title: '利润', $width: 180, titleAlign: 'center', columnAlign: 'right' },
				{ key: 'profitB', title: '利润%', $width: 110, titleAlign: 'center', columnAlign: 'right' },
				{ key: 'profit_GX', title: '贡献%', $width: 110, titleAlign: 'center', columnAlign: 'right' }
			]
		};
	},
	computed:{
	...
	methods: {
		...
		searchModeClick(type,loadDataNow=true){
			...
			switch (type){
				case '0':
				   item = { key: 'ct_Desc', title: '客户', $width: 260, titleAlign: 'center', columnAlign: 'center' }
					break;
				case '1':
				...
				default:
				    // 3
					 item ={ key: 'co_ArtId', title: '材质', $width: 260, titleAlign: 'center', columnAlign: 'center' }
					break;
			}
