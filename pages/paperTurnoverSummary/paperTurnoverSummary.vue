		...
		<view style="height: 15rpx;" class="flex border-top">
			<view class="flex-sub">
				...
				<view  :class="!hiddenLoadMore?'bottomMerge':'flex'">
					...
					<view class="title"><text class="text-bold" >出仓合计:</text>{{outsumMoney}}</view>
				</view>
				 </view>
			</view>
		</view>
	...
	data() {
		return {
			...
			dataColumnsCopy:[
				...
				{ key: 'OutWt', title: '出重量(T)', $width: 150, titleAlign: 'center', columnAlign: 'right' },
				{ key: 'NoTaxOutAmt', title: '出仓金额', $width: 200	, titleAlign: 'center', columnAlign: 'right' },
			]
		};
	},
	computed:{
