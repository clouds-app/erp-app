		...
		<cu-custom bgColor="bg-gradual-blue" :isBack="true"><block slot="content">纸板出仓扫描</block></cu-custom>
			...
			<view class="cu-modal" :class="modalName=='DialogModal1'?'show':''">
				<view class="cu-dialog">
					...
					<!-- <view class="padding-xl" style="font-size: 20px;">
						<view>工单号：{{findGoodsTableDataItems.OrderNo}}</view>
						<view>工单信息：{{findGoodsTableDataItems.CustName}},
										{{findGoodsTableDataItems.PaperInfo}}
										</view>
						<view>库存：{{findGoodsTableDataItems.Store}} 
							未送数：{{findGoodsTableDataItems.NoDueQty}}
						</view>
					</view> -->
