...
export default {
	...
	methods: {
		...
		restFrom(){
			...
			// this.boxHalfProdIn.wpl_WorkPrice = '';
			// this.boxHalfProdIn.wplAssNum=1//计件系数
			// this.boxHalfProdIn.wpl_WorkPriceUnitName=''////工价单位
			// this.boxHalfProdIn.wpl_WorkPriceUnit=''////工价单位
			// this.boxHalfProdIn.wpl_WorkPrice=''////工价单位
			this.fromdata = [];
			this.boxHalfProdIn.hp_bi_WorkNo = '';
