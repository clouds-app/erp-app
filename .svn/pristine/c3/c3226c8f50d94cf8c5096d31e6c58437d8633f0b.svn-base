	...
	<view>
		...
		<view class="bodyContentHeight">
			<view ref="elForm"  class="cu-form-group border-top elForm">
					<view style="margin-left: -15px;" class="title">客ㅤ户:</view>
					<input style="margin-left: 8px;" @tap="openDrawer" disabled v-model="model.customerName"  placeholder="请选择客户" name="input"></input>
