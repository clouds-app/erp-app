<template>
	<view>	
		<view  class="cu-form-group border-top">
			<view  class="title" :style="[{color:titleColor,padding:0}]" :class="[titleColor=='red'?'fontweight':'']">{{title}}</view>
			<input @click="showModal" disabled v-model="formItem.customers"  :placeholder="placeholdertext" name="input" ><!-- @blur="inputBlur" --></input>
