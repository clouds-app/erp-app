						...
						<view  style=" height: 100rpx; overflow: hidden;" class="flex-sub base-height">
							<view class="grid col-4">
								<view class="bg-img" v-for="(item,index) in imgList" :key="index" @tap="ViewImage" :data-url="imgList[index]">
								 <image style="width: 100rpx; height: 100rpx; background-color: #eeeeee; border: 1px solid #ccc;" :src="imgList[index]" mode="aspectFill"></image>
	...
	data() {
		return {
			...
			dataColumns: [
				...
				{ key: 'phoneno', title: '手机号', $width: 200, titleAlign: 'center', columnAlign: 'right' },
